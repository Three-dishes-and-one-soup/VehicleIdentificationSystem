...
def predict():
    ...
    SAVER_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'License_plate/train-saver/province/')
     
    PROVINCES = ("京","闽","粤","苏","沪","浙","津","渝","冀","豫","云","辽","黑","湘","皖","鲁","新","赣","鄂","桂","甘","晋","蒙",
                 "陕","吉","贵","青","藏","川","宁","琼")
