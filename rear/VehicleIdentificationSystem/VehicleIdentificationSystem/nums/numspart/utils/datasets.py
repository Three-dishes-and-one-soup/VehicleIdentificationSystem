...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=300):
        self.mode = 'images'
        self.img_size = img_size
        ...
        for i, s in enumerate(sources):
            ...
            # self.imgs[i] = imutils.resize(self.imgs[i], width=self.img_size)
    ...
    def update(self, index, cap):
        ...
        while cap.isOpened():
            ...
            if n == 4:  # read every 4th frame
                ...
                self.imgs[index] = imutils.resize(self.imgs[index], width=self.img_size)
                n = 0
